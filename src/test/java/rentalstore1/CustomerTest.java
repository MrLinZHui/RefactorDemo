...
public class CustomerTest {
    ...
    public void should_return_correct_statement_given_customer_has_rent_one_regular_movie_for_1_day() {
        Movie regularMovie = new RegularMovie("Titanic", 0);
    ...
    public void should_return_correct_statement_given_customer_has_rent_one_new_release_movie_for_1_day() {
        Movie newReleaseMovie = new NewReleaseMovie("Titanic", 1);
    ...
    public void should_return_correct_statement_given_customer_has_rent_one_child_movie_for_1_day() {
        Movie childrenMovie = new ChildrensMovie("Titanic", 2);
    ...
    @Test
    public void should_return_correct_statement_given_customer_has_no_rental_html() {
        String statement = customer.statement(new HtmlStatement());

        assertEquals("<H1>Rental Record for <EM>Jerry</EM></H1><P>\n" +
